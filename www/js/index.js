...
function displayData(data) {
    ...
    data.scores.forEach(function(value) {
        ...
        games.forEach(function (item) {
            ...
            home.className = "home";
            home.innerHTML = "<img id='teamlogo' src='img/"+homeTeam+".svg'/>" + homeTeam + " " + "<b>" + item.home_score + "</b>" + "&nbsp" + "<br>";
            let away = document.createElement("div");
            away.className = "away";
            away.innerHTML = "<b>" + item.away_score + " " + "</b>" + awayTeam + "&nbsp" + "<br>" + " " + "<img id='teamlogo' src='img/"+awayTeam+".svg'/>";
...
function StandingsData() {
    ...
    garray.forEach(function(data) {
        ...
        tdn.innerHTML = "<img id='teamlogo' src='img/"+data.id+".svg'/>" + " " + data.id;
